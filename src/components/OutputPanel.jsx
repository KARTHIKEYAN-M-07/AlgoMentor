...
export default function OutputPanel() {
  ...
  return (
    <motion.div
      ...
      className="w-full bg-slate-900 rounded-2xl border border-slate-800 shadow-xl overflow-hidden p-6 flex flex-col gap-5"
    >
      {/* HEADER */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800/80">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <button
            ...
            className="p-2 rounded-lg bg-slate-800/60 hover:bg-slate-800 text-slate-400 hover:text-slate-200 border border-slate-700/50 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
        ...
        <div className="flex flex-col gap-5">
          ...
          {stdout && (
            <motion.div
              ...
              className="rounded-xl border border-slate-800/90 bg-slate-950 overflow-hidden shadow-inner flex flex-col"
            >
          ...
          {stderr && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-xl border border-red-500/40 bg-red-950/20 overflow-hidden shadow-inner flex flex-col"
            >
          ...
          {compileOutput && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="rounded-xl border border-amber-500/40 bg-amber-950/20 overflow-hidden shadow-inner flex flex-col"
            >
